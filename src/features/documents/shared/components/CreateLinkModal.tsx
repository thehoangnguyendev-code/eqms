      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-2xl w-full max-w-2xl border border-slate-200 overflow-hidden relative z-10 flex flex-col"
            style={{
