    ...
    return (
      ...
      >
        ...
        <div className="flex items-center rounded-t-xl justify-between px-4 py-3 bg-slate-50 border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="icon-sm" onClick={handleZoomOut} disabled={zoomLevel <= 20} title="Zoom Out">
              <ZoomOut className="h-4 w-4" />
            </Button>
            <div className="min-w-[70px] text-center">
              <span className="text-xs sm:text-sm font-medium text-slate-700">{zoomLevel}%</span>
            </div>
            <Button variant="outline" size="icon-sm" onClick={handleZoomIn} disabled={zoomLevel >= 200} title="Zoom In">
              <ZoomIn className="h-4 w-4" />
            </Button>
            <div className="w-px h-6 bg-slate-300 mx-1" />
            <Button variant="outline" size="icon-sm" onClick={handleResetZoom} title="Reset Zoom">
