...
export const CertAddModal: React.FC<CertAddModalProps> = ({ onClose, onSave, editing }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-xl shadow-2xl w-full max-w-lg border border-slate-200 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
