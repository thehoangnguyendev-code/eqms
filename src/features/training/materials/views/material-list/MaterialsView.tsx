          ...
          <div className="p-4 lg:p-6 flex-1 flex flex-col">
            ...
            <div className="flex-1 flex flex-col relative">
              ...
              <div className={cn(
                ...
                <div className="overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100 hover:scrollbar-thumb-slate-400 scrollbar-thumb-rounded-full scrollbar-track-rounded-full flex-1">
