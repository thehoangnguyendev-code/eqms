...
export const MOCK_EMPLOYEE_PROGRESS: EmployeeProgress[] = [
  ...
  { userId: "EMP-1006", name: "Vo Thi Phuong", email: "phuong.vo@company.com", department: "Production", businessUnit: "Operation Unit", position: "Production Supervisor", enrollmentStatus: "Completed", resultStatus: "Pass", score: 7, completedAt: "2026-02-13", examDate: "2026-02-13", attempts: 2 },
