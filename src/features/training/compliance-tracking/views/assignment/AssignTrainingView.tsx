...
export const AssignTrainingView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 w-full flex-1 flex flex-col">
      ...
      {/* Step content */}
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-5 sm:p-6 flex-1 w-full">
        {currentStep === 1 && (
          <Step1CourseSelect
...
const Step2Assignees: React.FC<Step2Props> = ({
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-base font-semibold text-slate-900 mb-1">Select Assignees</h2>
        <p className="text-sm text-slate-500">Choose who should receive this training assignment.</p>
      </div>
...
const Step3Config: React.FC<Step3Props> = ({
  ...
  <div className="space-y-5">
    <div>
      <h2 className="text-base font-semibold text-slate-900 mb-1">Assignment Configuration</h2>
      <p className="text-sm text-slate-500">Set deadline, priority, and compliance options.</p>
    </div>
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="space-y-4 lg:col-span-6">
          {/* ─── COURSE DETAILS CARD (STEP 4 REVIEW) ─── */}
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
            {/* Header: Đồng bộ với Config và Assignees */}
              ...
              {course?.type && (
                <Badge
                  ...
                  className={cn(
                    ...
                    TYPE_BADGE_COLORS[course.type] // Sử dụng mapping màu có sẵn của bạn
                  )}
                >
                  {course.type}
                </Badge>
        ...
        <div className="space-y-4 lg:col-span-6">
          ...
          {/* ─── AUTHORIZATION CARD (ASSIGNED BY) ─── */}
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            <div className="bg-slate-50/50 border-b border-slate-100 px-5 py-3 flex items-center justify-between">
              <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="bg-slate-50/80 px-5 py-2.5 border-t border-slate-100">
              <p className="text-xs text-slate-400 mt-1 flex items-center gap-1 flex items-center gap-1">
